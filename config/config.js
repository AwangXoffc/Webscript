const CONFIG = {
    ...
    socials: [
        ...
        { name: "Telegram", link: "https://t.me/awangoffc", icon: "tele" },
        { name: "Portfolio", link: "https://portofolio.awangofc.my.id", icon: "port" }
    ],
    ...
    items: [
        ...
        {
            id: "sc_hydro_md",
            title: "HYDRO MULTI DEVICE",
            description: "SC BOT TERBRU || HYDRO MD || TOTAL FITUR 1000+ || NO ENC || SUPPORT BUTTON || Awang OfficiaL",
            version: "V5.3",
            tags: ["JAVASCRIPT", "NODEJS", "BOTWHATSAAP"],
            thumbnail: "https://youtu.be/8TFTOnbdpRM?si=I7aG9mb2JR3_SHvw",
            downloadLink: "https://www.mediafire.com/file/ig4ejkrmeyr80ru/hydromd-5.3.zip/file?dkey=xle5ee98rp9&r=532",
    ...
    siteUpdates: [
        {
            title: "Update Sistem Ai",
            description: "Update Terbaru Di Chat Ai, kini bisa menganalisis jika pengguna mengirim gambar/video/document",
            date: "2026-06-02",
            type: "feature",
            actionUrl: "/view/ai.html"
        },
        {        
    ...
    footerPages: {
        tos: {
            ...
            content: `
                <div class="space-y-4">
                    <div class="bg-[#0f172a] p-4 rounded-2xl border border-[#60a5fa]/40 shadow-inner">
        ...
        privacy: {
            ...
            content: `
                <div class="bg-[#0f172a] p-6 rounded-3xl border border-[#60a5fa]/40 shadow-inner space-y-4">
            ...
            content: `
                <div class="text-center">
                    <div class="relative w-24 h-24 mx-auto mb-4">
                        <img src="assets/images/profile.jpg" onerror="this.src='../assets/images/profile.jpg'" class="w-full h-full rounded-full border-2 border-[#60a5fa] object-cover shadow-[0_0_20px_rgba(96,165,250,0.5)]">
                    </div>
                    ...
                    <div class="bg-[#1e293b]/50 p-4 rounded-2xl border border-[#60a5fa]/40 shadow-inner">
    ...
    aiSystem: {
        ...
        systemInstruction: `
            KAMU ADALAH "AXO AI". ASISTEN VIRTUAL TERCANGGIH DARI AWANGXOFFC ID.
            ...
            *Selalu terjemahkan permintaan user menjadi bahasa Inggris yang sangat deskriptif agar gambarnya bagus.*
            ...
            [SUPER POWER 6: ANALISA FILE MULTIMEDIA]
            - Kamu bisa menganalisa gambar, video, dan dokumen/file yang diunggah user.
            Berikan respons akurat, sesuai konteks isi file, dan tidak asal menjawab.
            ...
            - FORMAT RESPON: Jika penjelasan panjang melebihi 1 paragraf, beri jeda/spasi kosong (enter) antar paragraf agar terlihat rapi dan profesional.
        `,

        welcomeMessage: "Woi Bro! Gw aXo AI (Mode: Super Brain). Mau script bot, solusi coding, gambar AI, atau sekadar gabut? Gas ngobrol!"
    }
};